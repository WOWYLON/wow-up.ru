...
- Перед публикацией добавьте файл `favicon.ico` и `og-image.jpg` в корень сайта, а также `cover.jpg`, изображения категорий и слайды `about1.jpg`, `about2.jpg`, `about3.jpg` в папку `img/`.
