...
if ( ! class_exists( 'vixan_Walker_Nav_Primary' ) ) {
//     /**
//      * vixan_Walker_Nav_Primary class.
//      *
//      * @extends Walker_Nav_Menu
//      */
    class vixan_Walker_Nav_Primary extends Walker_Nav_Menu {
        /**
         * Start Level.
         *
        ...
        public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            if ( 0 === strcasecmp( $item->attr_title, 'divider' ) && 1 === $depth ) {
                ...
                if ( $args->has_children ) {
                    $class_names .= ' menu-item-has-black-section cs_style_1 dropdown';
                }
        ...
        public static function fallback( $args ) {
            if ( current_user_can( 'edit_theme_options' ) ) {
                ...
                echo '>';
                echo '<li><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" title="' . esc_attr( 'Add a menu', '' ) . '">' . esc_html( 'Add a menu', '' ) . '</a></li>';
                echo '</ul>';
                if ( $container ) {
                    echo '</' . esc_attr( $container ) . '>'; }
            }
