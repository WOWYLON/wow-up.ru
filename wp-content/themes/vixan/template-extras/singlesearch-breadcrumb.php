            ...
            <div class="col-xl-12">
                <div class="page-header__wrapper">
                    <div class="page-header__content">
                        ...
                        <h2> <?php esc_html_e('Search Result for: ','vixan'); ?> <?php printf( get_search_query() ); ?></h2>    

                        <div class="page-header__menu">
                            <ul>
                                <li><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e('Home/search', 'vixan'); ?></a></li>
                                <li><?php printf( get_search_query() ); ?></li>
                            </ul>
                        </div>
                    </div>
                </div>
